  ...
  return (
    <div className="px-4 pt-10 md:px-10 w-full">
      <Title
        ...
        subtitle="Suivez toutes les réservations des clients, approuvez ou annulez les demandes, et gérez les statuts de réservation."
      />
        ...
        <table className="w-full border-collapse text-left text-sm text-gray-600">
          <thead className="text-gray-500">
            <tr>
              ...
              <th className="p-3 font-medium max-md:hidden">Période</th>
              <th className="p-3 font-medium">Total</th>
              <th className="p-3 font-medium max-md:hidden">Paiement</th>
