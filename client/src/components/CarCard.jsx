    ...
    >
      <div className="relative h-48 overflow-hidden">
        <img
          src={car.image}
          alt="car image"
          className="w-full h-full object-cover transition-transform duration-500 groub-hover:scale-105"
        />
        {car.isAvailable && (
          <p
      ...
      text-white px-3 py-2 rounded-lg"
        >
          ...
          <span className="text-sm text-white/80"> / jour</span>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-y-2 text-gray-600">
          <div className="flex items-center text-sm text-muted-foreground">
            ...
            <span>{car.seating_capacity} sièges</span>
          </div>
          <div className="flex items-center text-sm text-muted-foreground">
